...
#set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { echo }]; #IO_L20N_T3_A19_15 Sch=ja[1]
#set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { trigger }]; #IO_L21N_T3_DQS_A18_15 Sch=ja[2]
...
#set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS33 } [get_ports { trigger }]; #IO_L14N_T2_SRCC_15 Sch=jb[2]
